...
assert.match(startOwn, /stb-store-handoff-contract\.js\?v=e810ce44/);
...
assert.match(shell, /stb-store-handoff-contract\.js\?v=e810ce44/);
assert.match(shell, /stb-start-own-0\.11\.html\?v=5e148202/);
