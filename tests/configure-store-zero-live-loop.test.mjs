...
assert.match(startOwn, /stb-store-handoff-contract\.js\?v=59522da9/);
...
assert.match(shell, /stb-store-handoff-contract\.js\?v=59522da9/);
assert.match(shell, /stb-start-own-0\.11\.html\?v=eeef28d3/);
