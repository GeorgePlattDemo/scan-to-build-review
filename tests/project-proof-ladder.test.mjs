...
assert.match(shell, /src="stb-start-own-0\.11\.html\?v=fdd51d62"/);
...
assert.match(proofStoreBlock, /MATERIAL CATALOG/);
assert.match(proofStoreBlock, /4402abeb6b02/);
assert.match(proofStoreBlock, /CAPABILITY AUTHORITY/);
assert.match(proofStoreBlock, /f88ec61c4244/);
...
assert.match(proofStoreBlock, /PROCESSING \/ RECOVERY/);
assert.match(proofStoreBlock, /TOTAL REFERENCE PRICE/);
assert.match(proofStoreBlock, /UNRESOLVED · COMPLETE VALUE NOT ESTABLISHED/);
