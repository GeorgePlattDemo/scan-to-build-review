...
assert.match(shell,/src="stb-start-own-0\.11\.html\?v=9c616fec"/);
assert.equal(gitBlobSha(candidate),'9c616fec7decdaafb24a64a986fc63ac7fba1e85','Start Your Own 0.11 repaired candidate changed unexpectedly');
