...
assert.match(shell,/src="stb-start-own-0\.11\.html\?v=01bc520c"/);
assert.equal(gitBlobSha(candidate),'01bc520c619fa17d443438e5c0c875201dc7a2f7','Start Your Own 0.11 candidate changed unexpectedly');
