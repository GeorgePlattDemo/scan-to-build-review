...
assert.match(shell,/src="stb-start-own-0\.11\.html\?v=b6c5e4a6"/);
assert.equal(gitBlobSha(candidate),'b6c5e4a66d00e6c8676c09681be6063246b75f55','Start Your Own 0.11 current artifact changed unexpectedly');
